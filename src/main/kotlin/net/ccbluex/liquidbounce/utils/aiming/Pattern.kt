...
object GaussianPattern : Pattern {
    ...
    private const val STANDING_CHANCE: Double = 0.0
    private const val MOVING_CHANCE: Double = 0.0

    private const val SPEED_HORIZONTAL_LIMITER: Double = 0.0
    private const val SPEED_VERTICAL_LIMITER: Double = 0.0
