...
class GlfwInputAdapter {
    ...
    fun cursorPosCallback(window: Long, x: Double, y: Double) {
        ...
        val event = UltralightMouseEvent()
            ...
            .button(
                when (GLFW_PRESS) {
                    glfwGetMouseButton(window, GLFW_MOUSE_BUTTON_LEFT) -> UltralightMouseEventButton.LEFT
                    glfwGetMouseButton(window, GLFW_MOUSE_BUTTON_MIDDLE) -> UltralightMouseEventButton.MIDDLE
                    glfwGetMouseButton(window, GLFW_MOUSE_BUTTON_RIGHT) -> UltralightMouseEventButton.RIGHT
                    else -> null
                }
            )
